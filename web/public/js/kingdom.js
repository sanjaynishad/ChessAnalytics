...
(function () {
    ...
    function calculate_board_size(w, h) {
        ...
        w = w || document.getElementById("chess-board").offsetWidth;
        h = w || document.getElementById('chess-board').offsetHeight;
    ...
    function make_rating_slider() {
        ...
        obj.resize = function () {
            container.style.width = (board.el.clientWidth / 14) + "px";
            container.style.height = board.board_details.width + "px";
